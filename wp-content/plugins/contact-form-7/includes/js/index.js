    ...
    var o = function (e) {
            ...
            return i.reduceRight(
                ...
                function (e) {
                    ...
                    "string" == typeof s && ((t = a.replace(/^\/|\/$/g, "")), (i = (r = s.replace(/^\//, "")) ? t + "/" + r : t)),
                        "string" == typeof i && (-1 !== n.indexOf("?") && (i = i.replace("?", "&")), (i = i.replace(/^\//, "")), (o = n + i)),
                        delete (u = c({ Accept: "application/json, */*;q=0.1" }, u))["X-WP-Nonce"],
